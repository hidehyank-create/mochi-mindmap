...
(function installFix27R(){
  ...
  if(window.__mochiFix27RInstalled&&window.__mochiFix27RBuild==="0917-FIX27X")return;
  window.__mochiFix27RInstalled=true;
  const F27R_BUILD="0917-FIX27X",P=window.__mochiFix27PTest;
  ...
  function append(d,attrs){
    // Keep the red dashed contour unchanged.  Only the under-contour's
    // background cover is narrowed, so shadows and neighboring strokes are
    // not erased across the full dashed-line width.
    const underContour=attrs["data-f27r-contour"]==="link-exterior";
    hiddenLayer.appendChild(sEl("path",{d,class:"hidden-mask","data-f27r-mask":"1",fill:"none",stroke:"#f7f4ed","stroke-width":underContour?3:7,"stroke-linecap":"round","stroke-linejoin":"round"}));
