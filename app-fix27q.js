...
(function installFix27Q(){
  ...
  if(!document.getElementById("f27rLoaderLatest")){const s=document.createElement("script");s.id="f27rLoaderLatest";s.src="app-fix27r.js?v=0917-fix27ah";document.body.appendChild(s)}
