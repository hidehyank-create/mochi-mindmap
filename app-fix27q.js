...
(function installFix27Q(){
  ...
  if(!document.getElementById("f27rLoader")){const s=document.createElement("script");s.id="f27rLoader";s.src="app-fix27r.js?v=0917-fix27ac";document.body.appendChild(s)}
