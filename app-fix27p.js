...
(function installFix27P(){
  ...
  if(!document.getElementById("f27qLoader")){const s=document.createElement("script");s.id="f27qLoader";s.src="app-fix27q.js?v=0917-fix27ae";document.body.appendChild(s)}
})();
