...
(function installFix27P(){
  ...
  if(!document.getElementById("f27qLoaderLatest")){const s=document.createElement("script");s.id="f27qLoaderLatest";s.src="app-fix27q.js?v=0917-fix27ah";document.body.appendChild(s)}
})();
