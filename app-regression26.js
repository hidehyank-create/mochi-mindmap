...
(function(){
  ...
  test("F26-07 紐に触れる位置では接着候補を拒否",()=>{reset([N("target",500,350,70,1),N("hoseEnd",800,350,50,1),N("m",500,235,55,2)],[L("targetHose","target","hoseEnd",1,1)]);const g={nodeId:"m",compIds:["m"]};A(T.predictAttachAllowed(g,{movedId:"m",otherId:"target"})===false,"紐接触位置で接着可能")});
